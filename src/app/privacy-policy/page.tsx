...
export default function Faqs() {
  ...
  return (
    <main className="flex md:min-h-screen flex-col items-center m-auto justify-between bg-white">
      <div className="max-w-7xl w-full p-3 lg:p-6 pt-8 gap-8 text-black">
      ...
      <strong>
        ...
        <br/>
        <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to Email, Name, Password. The information that the Service Provider request will be retained by them and used as described in this privacy policy.</p>
        <br/>
        ...
        <br/>
        <p>This privacy policy is effective as of 2024-09-09</p>
        <br/>
